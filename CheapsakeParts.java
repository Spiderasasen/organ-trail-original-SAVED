...
public class CheapsakeParts
  {
    ...
    { 
      ...
      for(int i = 0; i < 100000; i++)
      {
        ...
        {
          int math = 0;
          int oxenSell = (int) (Math.random() * 10);
        ...
        {
          int math = 0;
          int foodSell = (int) (Math.random() * 10);
        ...
        {
          int math = 0;
          int clothesSell = (int) (Math.random() * 10);
        ...
        {
          int math = 0;
          int ammoSell = (int) (Math.random() * 10);
        ...
        {
          int math = 0;
          int partSell = (int) (Math.random() * 7);
    ...
    public void collecting()
    {
      ...
      int whichBerry = (int) (Math.random() * 3);
    ...
    public void heal()
    {
      ...
      else if(healing <= 5) //saved the person
      {
