...
public class Game
  {
    ...
    DoctorGame doctor = new DoctorGame();
    HunterGame hunter = new HunterGame();
    FamerGame farmer = new FamerGame();
    CheapsakeGame cheapsake = new CheapsakeGame();
    RichGame rich = new RichGame();
