...
public class RichParts
  {
    ...
    {
      //random numbers
      int bulletsLost = (int) (Math.random() * 20); //how many bullets you lost
    ...
    public void collecting()
    {
      ...
      int whichBerry = (int) (Math.random() * 30);
    ...
    public void nextDay()
    {
      ...
      {
        int gainedMoney = (int) (Math.random() * 500) + 2;
