...
public class HunterParts
  {
    ...
    {
      //random numbers
      int bulletsLost = (int) (Math.random() * 3) + 1; //how many bullets you lost
      ...
      int typeOfAnimal = (int) (Math.random() * 6) + 0; //what animal you killed
      if(numBullets == 0)
      {
    ...
    public void collecting()
    {
      ...
      int whichBerry = (int) (Math.random() * 10);
